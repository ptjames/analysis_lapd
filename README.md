...
## Motivation
This analysis explores the following qustion: When a police officer makes vehicle stops with other officers, does he/she incorporate biases in how the other officers stop various demographics into his/her own policing?
...
4) [Iterate over each demographic](https://github.com/ptjames/analysis_lapd/blob/master/analysis/analysis.py#L470-L472)
    * [Create training and evaluation datasets from stored modeling data](https://github.com/ptjames/analysis_lapd/blob/master/analysis/analysis.py#L475-L483)
